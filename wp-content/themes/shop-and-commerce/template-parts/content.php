...
<article id="post-<?php the_ID(); ?>" <?php post_class('animate-article'); ?>>
	<header class="entry-header">
		...
		<div class="entry-meta">
			<?php shop_and_commerce_posted_on(); ?>
		</div><!-- .entry-meta -->
		<?php
		endif; ?>
	...
	<?php $shop_and_commerce = get_post_meta($post->ID, 'my_shop_and_commerce_name', true); 
		if ($shop_and_commerce) {
			echo '<div class="seos-video">' . esc_html($shop_and_commerce) . '</div>';
	} ?>
	...
	<footer class="entry-footer">
		<?php shop_and_commerce_entry_footer(); ?>
	</footer><!-- .entry-footer -->
</article><!-- #post-## -->
