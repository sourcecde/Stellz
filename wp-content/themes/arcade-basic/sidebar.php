	...
	<div id="secondary" <?php bavotasan_sidebar_class(); ?> role="complementary">
		<?php if ( ! dynamic_sidebar( 'sidebar' ) ) : ?>
			<aside id="meta" class="widget">
				...
				<p><?php printf( __( 'This is just a default widget. It\'ll disappear as soon as you add your own widgets on the %1$sWidgets admin page%2$s.', 'arcade-basic' ), '<a href="' . admin_url( 'widgets.php' ) . '">', '</a>' ); ?></p>
